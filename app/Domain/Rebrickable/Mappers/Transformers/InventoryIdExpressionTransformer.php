...
class InventoryIdExpressionTransformer implements RebrickableFieldTransformer
{
    /**
    ...
    {
        return new Expression("(SELECT id FROM inventories WHERE rebrickable_id = {$value})");
    }
}
