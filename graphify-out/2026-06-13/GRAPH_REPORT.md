# Graph Report - collect-connect  (2026-06-10)

## Corpus Check
- 426 files · ~575,206,808 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1591 nodes · 1841 edges · 288 communities (273 shown, 15 thin omitted)
...
5. `ImportColorBricqerImagesTest` - 17 edges
6. `ImportInventoryJob` - 16 edges
7. `Usage` - 16 edges
8. `require` - 15 edges
9. `ImportInventoryJobTest` - 15 edges
10. `ImportPartBricqerImageUrlsJobTest` - 13 edges
...
## Communities (288 total, 15 thin omitted)

### Community 0 - "Test Cases"
Cohesion: 0.06
Nodes (19): SearchControllerTest, self, BaseTestCase, ImportBrickerColorsJobTest, ExampleTest, ImportPartBricklinkNumbersJobTest, ImportPartBricqerImageUrlsJobTest, ProductColorImageTest (+11 more)
...
Cohesion: 0.34
Nodes (7): Dispatchable, InteractsWithQueue, ImportBrickerColorsJob, ImportPartBricqerImageUrlsJob, ImportRebrickableEntityJob, Queueable, ShouldQueue
...
Cohesion: 0.05
Nodes (27): BackedEnum, Schema, Table, Schema, TextColumn, Table, BackedEnum, Schema (+19 more)
...
Cohesion: 0.13
Nodes (8): Collection, Command, ImportBrickerColorsCommand, ImportInventoryCommand, ImportMinifigBricklinkNumbersCommand, ImportPartBricklinkNumbersCommand, ImportPartBricqerImageUrlsCommand, ImportPartColorBricqerImagesCommand
...
Cohesion: 0.19
Nodes (5): BricqerApi, GenerateSignedUploadUrl, Facade, Bricqer, Rebrickable
...
Cohesion: 0.38
Nodes (3): Builder, Batchable, ImportColorBricqerImagesJob
...
## Knowledge Gaps
- **366 isolated node(s):** `PreToolUse`, `allow`, `enableAllProjectMcpServers`, `enabledMcpjsonServers`, `@kilocode/plugin` (+361 more)
...
- **Why does `ImportInventoryJob` connect `Inventory Import Jobs` to `Command Handlers`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `TestCase` connect `Test Cases` to `Saloon API Responses`, `Community 107`, `Pagination Helpers`, `Inventory Import Jobs`, `Bricqer Image Import Tests`?**
